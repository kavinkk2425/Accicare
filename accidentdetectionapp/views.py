...
def maps(request):
    if GooglePlaces is None or types is None:
        return HttpResponse("Google Places dependency is unavailable in this environment, so nearby hospital search cannot run.")
